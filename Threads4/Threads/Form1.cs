        ...
        private void hilosEjecucionyPasarParametrosHudPS(FileSystemEventArgs e)
        {
            ...
            foreach (KeyValuePair<int, string> jugador in jugadores)
            {
                ...
                if (jugador.Value != null)
                {
                    ...
                    Hud jugador1 = new Hud();
                    jugador1.Jugador = jugador.Value.ToString();
                    jugador1.Tituloventana = nombreVentana.ToString();
                    jugador1.NumJugador = jugador.Key;
                    jugador1.JugadoresMesa = jugadoresMesa.ToString();
                    listaHuds.Add(jugador1);
                    jugador1.ShowDialog();
